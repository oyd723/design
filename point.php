          ...
          <li>
            ...
            <div class="point__box">
              ...
              <div class="point__txt">
                <div class="point__txt__num">01</div>
                <div class="point__ttl">
                  <span class="eng">title</span>
                  <span class="ja">タイトル</span>
                </div>
                <div class="point__detail">
                  <div><span>テキストテキストテキスト</span></div>
                </div>
                <div class="point__btn">
                  <a href="#">more<span class="btn__arrow"></span></a>
                </div>
              </div>
            </div>
